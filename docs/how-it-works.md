...
- [api/qr-generate.ts](../api/qr-generate.ts) stores the submitted registration in Supabase, enforces unique phone numbers, auto-generates the attendee ID, and creates a unique QR code.
